...
// Problem 1
//Selecting people in uk
let governmentWorkers = runners.filter(runner => runner.email.includes("uk"));
console.log(governmentWorkers);

// Problem 2
//Reversing first names and last names
let reversedNames =  runners.map(runner => {
  [runner.first_name, runner.last_name ] = [runner.last_name, runner.first_name ];
  return runner;
});
console.log(reversedNames);

// Problem 3
//Redact government workers
let redacted =  runners.map(runner => {
  if (runner.email.includes("gov")){
    runner.last_name = "====REDACTED====";
    runner.first_name = "====REDACTED====";
    runner.email = "====REDACTED====";
  }
  return runner;
});